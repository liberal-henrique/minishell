...
/*   Updated: 2023/05/24 15:38:37 by lliberal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/minishell.h"

// - Ja a expansao precisara de mais atencao.
// - Ja consigo criar a string com acrescimo do length do value da variavel encontrada.
// - Tambem, ja substitui o $ dentro da double quotes por 5.
// - Entao, agora, precisarei apenas percorrer a string e procurar pelo 5 e substituir
...
// void	length_value(char **env, char *str)
// {
// 	//char	*set;
// 	int		length;
// 	int		i;
